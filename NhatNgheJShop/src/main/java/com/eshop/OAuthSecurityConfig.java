	...
	protected void configure(HttpSecurity http) throws Exception {
	       http 
	        	...
	        	.and()
					 ...
					 * .userDetailsService(this.customerDetailsService) .rememberMeServices(null)
					 * .tokenValiditySeconds(2000) .useSecureCookie(true)
					 */
	        		//.rememberMe().tokenRepository(persistentTokenRepository())
	        	 	.rememberMe().tokenRepository(persistentTokenRepository())
	        	 		.key("uniqueAndSecret").tokenValiditySeconds(7 * 24 * 60 * 60)
	        	 		.userDetailsService(customerDetailsService)
	        		//.rememberMe().userDetailsService(this.customerDetailsService)
                .and()            
